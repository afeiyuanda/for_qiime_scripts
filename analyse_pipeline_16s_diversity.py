...
-biom /share/home/big/liuwei_test/picked_otus_uclust/otu_table_mc2_w_tax_no_pynast_failures.biom 
-group Treatment 
-tre /share/home/big/liuwei_test/picked_otus_uclust/rep_set.tre
		"""
...
def __main__():
	...
	newParser.add_argument( "-norm", dest="norm", type=int, help="normalization");
	...
	if os.path.exists(biom_file_dir+'/seqs_per_sample.txt'):
		...
		#subprocess.call('biom summarize-table -i '+biom+' -o '+biom_file_dir+'/seqs_per_sample.txt', stdout=subprocess.PIPE, shell=True)
		#subprocess.call('biom summarize-table -i '+biom+' --qualitative -o '+biom_file_dir+'/otus_per_sample.txt', stdout=subprocess.PIPE, shell=True)
	...
	if min_seqs_num == 1:
		min_seqs_num = 100
	m = min(1000, int(min_seqs_num*0.2))
	if len(seqs_num_list) == 1:
		max_seqs_num = int(reverse_seqs_num_list[0])
	else:
	...
	for group in group_list:
		...
		all_cmd_list.append('parallel_alpha_diversity.py -i '+new_outdir+'/alpha_diversity/rarefied_otu_tables -m ACE,simpson,shannon,PD_whole_tree,chao1,observed_species,goods_coverage -o '+new_outdir+'/alpha_diversity/adiv/ -t '+tre+' -O '+str(cpu))
		...
		all_cmd_list.append('python '+sys.path[0]+'/plot_rarefaction_curve_with_error_bar.py '+new_outdir+'/alpha_diversity/collated_alpha/ '+mapping+' '+group)
		...
		all_cmd_list.append('single_rarefaction.py -i '+new_outdir+'/sorted_otu_table.biom -o '+new_outdir+'/beta_diversity/otu_table_even.biom -d '+str(norm))
		all_cmd_list.append('parallel_beta_diversity.py -i '+new_outdir+'/beta_diversity/otu_table_even.biom -t '+tre+' -o '+new_outdir+'/beta_diversity/beta_div -O '+str(cpu))
		all_cmd_list.append('principal_coordinates.py -i '+new_outdir+'/beta_diversity/beta_div/ -o '+new_outdir+'/beta_diversity/beta_div_pca_result')
		all_cmd_list.append('python '+sys.path[0]+'/plot_pca_with_pc_vectors.py '+new_outdir+'/beta_diversity/beta_div_pca_result/pcoa_weighted_unifrac_otu_table_even.txt '+mapping+' '+group+' bottomright')
		all_cmd_list.append('python '+sys.path[0]+'/plot_pca_with_pc_vectors.py '+new_outdir+'/beta_diversity/beta_div_pca_result/pcoa_unweighted_unifrac_otu_table_even.txt '+mapping+' '+group+' bottomright')
		...
		all_cmd_list.append('alpha_diversity.py -i '+new_outdir+'/beta_diversity/otu_table_even.biom -m ACE,simpson,shannon,PD_whole_tree,chao1,observed_species,goods_coverage -o '+new_outdir+'/even_adiv.txt -t '+tre)
		...
		all_cmd_list.append('summarize_taxa_through_plots.py -i '+new_outdir+'/beta_diversity/otu_table_even.biom -o '+new_outdir+'/wf_taxa_summary_even -m '+mapping)
		all_cmd_list.append('jackknifed_beta_diversity.py -i '+new_outdir+'/sorted_otu_table.biom -t '+tre+'  -m '+mapping+' -o '+new_outdir+'/wf_jack -e '+str(depth))
		all_cmd_list.append('python '+sys.path[0]+'/generate_upgma_tree_images.py '+new_outdir)
		...
		all_cmd_list.append('python '+sys.path[0]+'/taxo_barplot_for30.56.py '+new_outdir+'/wf_taxa_summary_even/  '+new_outdir+'/taxa_summary_even')
		...
		os.system('parallel_alpha_diversity.py -i '+new_outdir+'/alpha_diversity/rarefied_otu_tables -m ACE,simpson,shannon,PD_whole_tree,chao1,observed_species,goods_coverage -o '+new_outdir+'/alpha_diversity/adiv/ -t '+tre+' -O '+str(cpu))
		...
		os.system('python '+sys.path[0]+'/plot_rarefaction_curve_with_error_bar.py '+new_outdir+'/alpha_diversity/collated_alpha/ '+mapping+' '+group)
		...
		os.system('single_rarefaction.py -i '+new_outdir+'/sorted_otu_table.biom -o '+new_outdir+'/beta_diversity/otu_table_even.biom -d '+str(norm))
		os.system('parallel_beta_diversity.py -i '+new_outdir+'/beta_diversity/otu_table_even.biom -t '+tre+' -o '+new_outdir+'/beta_diversity/beta_div -O '+str(cpu))
		os.system('principal_coordinates.py -i '+new_outdir+'/beta_diversity/beta_div/ -o '+new_outdir+'/beta_diversity/beta_div_pca_result')
		os.system('python '+sys.path[0]+'/plot_pca_with_pc_vectors.py '+new_outdir+'/beta_diversity/beta_div_pca_result/pcoa_weighted_unifrac_otu_table_even.txt '+mapping+' '+group+' bottomright')
		os.system('python '+sys.path[0]+'/plot_pca_with_pc_vectors.py '+new_outdir+'/beta_diversity/beta_div_pca_result/pcoa_unweighted_unifrac_otu_table_even.txt '+mapping+' '+group+' bottomright')
		...
		os.system('alpha_diversity.py -i '+new_outdir+'/beta_diversity/otu_table_even.biom -m ACE,simpson,shannon,PD_whole_tree,chao1,observed_species,goods_coverage -o '+new_outdir+'/even_adiv.txt -t '+tre)
		...
		os.system('summarize_taxa_through_plots.py -i '+new_outdir+'/beta_diversity/otu_table_even.biom -o '+new_outdir+'/wf_taxa_summary_even -m '+mapping)
		os.system('jackknifed_beta_diversity.py -i '+new_outdir+'/sorted_otu_table.biom -t '+tre+'  -m '+mapping+' -o '+new_outdir+'/wf_jack -e '+str(depth))
		os.system('python '+sys.path[0]+'/generate_upgma_tree_images.py '+new_outdir)
		...
		os.system('python '+sys.path[0]+'/plot_heatmap.py  '+new_outdir+'/OTU_Heatmap_even/even_otu_table_taxo_name.txt 80 TRUE')
		...
		os.system('python '+sys.path[0]+'/taxo_barplot_for30.56.py '+new_outdir+'/wf_taxa_summary_even/  '+new_outdir+'/taxa_summary_even')
		...
		collate_results_cmd.append('mkdir -p '+final_result_dir+'/PCoA/3DPCoA_weighted_unifrac')
		collate_results_cmd.append('mkdir -p '+final_result_dir+'/PCoA/3DPCoA_unweighted_unifrac')
		collate_results_cmd.append('mkdir -p '+final_result_dir+'/UPGMA')
		collate_results_cmd.append('mkdir -p '+final_result_dir+'/taxa_summary_even')
		collate_results_cmd.append('mkdir -p '+final_result_dir+'/unifrac_distance')
		...
		collate_results_cmd.append('mv '+new_outdir+'/beta_diversity/beta_div_pca_result/*.png '+final_result_dir+'/PCoA')
		collate_results_cmd.append('mv '+new_outdir+'/wf_jack/weighted_unifrac/emperor_pcoa_plots/* '+final_result_dir+'/PCoA/3DPCoA_weighted_unifrac')
		collate_results_cmd.append('mv '+new_outdir+'/wf_jack/unweighted_unifrac/emperor_pcoa_plots/* '+final_result_dir+'/PCoA/3DPCoA_unweighted_unifrac')
		...
		collate_results_cmd.append('mv '+new_outdir+'/UPGMA '+final_result_dir)
		collate_results_cmd.append('mv '+new_outdir+'/OTU_rank_abundance_even.png '+final_result_dir)
		collate_results_cmd.append('cp -r '+new_outdir+'/beta_diversity/beta_div/* '+final_result_dir+'/unifrac_distance')
		...
		os.system('mkdir -p '+final_result_dir+'/unifrac_distance')
		...
		os.system('mv '+new_outdir+'/beta_diversity/beta_div_pca_result/*.png '+final_result_dir+'/PCoA')
		os.system('mv '+new_outdir+'/wf_jack/weighted_unifrac/emperor_pcoa_plots/* '+final_result_dir+'/PCoA/3DPCoA_weighted_unifrac')
		os.system('mv '+new_outdir+'/wf_jack/unweighted_unifrac/emperor_pcoa_plots/* '+final_result_dir+'/PCoA/3DPCoA_unweighted_unifrac')
		os.system('mv '+new_outdir+'/taxa_summary_even '+final_result_dir)
		os.system('rm '+final_result_dir+'/taxa_summary_even/*/*.r*')
		os.system('mv '+new_outdir+'/UPGMA '+final_result_dir)
		os.system('mv '+new_outdir+'/OTU_rank_abundance_even.png '+final_result_dir)
		os.system('cp -r '+new_outdir+'/beta_diversity/beta_div/* '+final_result_dir+'/unifrac_distance')
