...
if(bar ==\"T\"){
	...
	text(cex=0.2,x=bar_plot, y=-2, xpd=TRUE, lab=colnames(otu), srt=45, adj=1, font=1) # srt control the angle, y control the distance between column name and the x axis
